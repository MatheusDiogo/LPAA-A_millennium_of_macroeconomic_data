...
plt.tight_layout()
plt.savefig(Pasta_Salvar + 'Livestock products production in millions.png')
plt.close()
...
plt.tight_layout()
plt.savefig(Pasta_Salvar + 'Livestock products production in millions unico.png')
plt.close()
...
plt.tight_layout()
plt.savefig(Pasta_Salvar + 'Livestock products production comparatade.png')

dfi.export(dados_Seculo_pct.apply(pd.to_numeric, errors='coerce').round(1).T, Pasta_Salvar + 'Livestock Production for Century.png')
plt.close()
...
plt.tight_layout()
plt.savefig(Pasta_Salvar + 'Correlation Heatmap - Population and Livestock.png')
plt.close()